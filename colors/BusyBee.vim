...
<!-- saved from url=(0063)http://vimcolorschemetest.googlecode.com/svn/colors/BusyBee.vim -->
<html><script id="tinyhippos-injected">if (window.top.ripple) { window.top.ripple("bootstrap").inject(window, document); }</script><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Maintainer:	Patrick J. Anderson
" Version:      1.0.1
